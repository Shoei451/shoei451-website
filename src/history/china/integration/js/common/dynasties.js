...
const DYNASTIES = [
...

  {
    ...
    capital:   '建康（東晋） / 各地（諸国）',
    color:     '#6A7A5A',
    nameAlts:  ['東晋', '五胡', '十六国', '前趙', '後趙', '前秦', '後秦', '前燕'],
    quizMatch: ['東晋'],
    territories: [
      { name: '東晋', ratio: 0.4 },
      { name: '五胡', ratio: 0.6 },
      ...
      groups: [
        {
          label: '江南',
          tracks: [
            { name: '東晋', start: 317, end: 420, color: '#7A8A6A' },
          ]
        },
        {
          label: '華北（代表）',
...

  {
    ...
    color:     '#5A7080',
    nameAlts:  ['南朝', '北朝', '北魏', '東魏', '西魏', '北斉', '北周', '宋', '斉', '梁', '陳'],
    quizMatch: ['南北朝', '北魏'],
    territories: [
      { name: '北朝', ratio: 0.5 },
      { name: '南朝', ratio: 0.5 },
    ],
    systems:   ['均田制（北朝）', '府兵制', '三長制', '九品中正法（南朝）', '漢化政策'],
...

  {
    ...
    systems:   ['三省六部制', '科挙制発展', '律令制完成', '均田制→両税法', '節度使'],
    figures:   ['李淵', '李世民（太宗）', '則天武后', '玄宗', '李白', '杜甫', '白居易', '玄奘'],
...

  {
    ...
    systems:   ['文治主義', '科挙拡大', '募兵制', '澶淵の盟', '海上貿易', '市舶司', '猛安謀克制（金）'],
    figures:   ['趙匡胤', '王安石', '司馬光', '朱熹', '岳飛', '耶律阿保機', '完顔阿骨打'],
...

  {
    ...
    systems:   ['モンゴル第一主義', '四等人制', '色目人優遇', '駅伝制（ジャムチ）'],
...

  {
    ...
    systems:   ['六部直属制（宰相廃止）', '里甲制', '一条鞭法', '海禁→朝貢貿易', '東林党'],
...
// era の表示順を固定する
const ERA_ORDER = ['古代', '分裂の時代', '隋・唐の時代', '五代十国', '宋と異民族国家', '元・明・清'];
